...
**Сжатое продолжение длинной сессии:** если пользователь явно просит перенести/сжать старую сессию в новую как продолжение, сначала `previewContinuationSession` для исходного ID. Preview read-only и не меняет канон. `createContinuationSession` вызывай только после явного согласия пользователя на создание новой continuation-сессии. Исходную сессию не удаляй и не изменяй. Новая сессия продолжает прошлый канон, но её технический счётчик ходов начинается с 0; старые bridge-ходы не переигрывать.
