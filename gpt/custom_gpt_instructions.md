...
3. Сначала `knowledge_firewall_v5`, затем `runtime_rules`, `scene_builder`, registry/relations/state, scene_history/chronology/continuity и `narrative_guardrails`. Вне window → `prepareSceneArchiveRead`; далее `getSceneArchiveChunk`.
