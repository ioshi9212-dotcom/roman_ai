...
## Ввод POV
Всё вне `( )` уже сказано POV вслух. Сохраняй слова, мат, сленг, тон и смысл; исправляй только очевидные опечатки. В `( )` — действие/мысль/ремарка, кроме явно указанной коммуникации. Обычные ответы, шутки, сарказм, вопросы и реакции POV можно продолжать самостоятельно; поворотные решения оставляй игроку.
