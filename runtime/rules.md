...
## POV
- `ordered_segments` выполняй строго слева направо как последовательность моментов: реплика → действие/мысль в `( )` → следующая реплика → следующее действие/мысль. Не склеивай реплики POV и не переноси действие/мысль за более поздний сегмент. Между сегментами допустимы естественные реакции NPC, паузы и события, если они логичны; не вставляй их механически.
