...
## POV
- `ordered_segments` строго слева направо: реплика → `(действие/мысль)` → следующая реплика; не склеивай реплики POV и не переноси скобочный сегмент. Между сегментами возможны логичные реакции NPC/паузы/события, не механически.
