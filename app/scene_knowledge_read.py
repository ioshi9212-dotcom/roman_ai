...
def scene_knowledge_read_status(
    ...
    return {
        ...
        "scene_directing_reminder": (
            "После полного чтения знаний пиши сцену по scene_builder. Режиссура показывает только происходящее: "
            "не перечисляй, чего персонажи НЕ сделали/НЕ сказали/НЕ предложили, и не комментируй смысл, мораль, "
            "психологическую правильность или границы. POV остаётся активным живым участником после user_input: "
            "обычные низкорисковые реплики и мелкие действия продолжай естественно; одних пассивных ощущений/наблюдений "
            "недостаточно. В населённой локации фоновые одноразовые NPC могут естественно присутствовать, говорить и "
            "вмешиваться без карточки и полного knowledge-read; карточка/read нужны только устойчивому/важному "
            "зарегистрированному персонажу."
        ),
    }
