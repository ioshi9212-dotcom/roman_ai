...
def _rewrite_context(session_id: str, context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    contract.update({
        ...
        "runtime_documents_authoritative": True,
        "runtime_documents_must_be_read_in_full": True,
        "runtime_rules_must_be_followed_literally": True,
        "scene_builder_must_be_followed_literally": True,
        "scene_builder_format_is_commit_gate": True,
        "generated_shortcuts_may_not_override_runtime_documents": True,
