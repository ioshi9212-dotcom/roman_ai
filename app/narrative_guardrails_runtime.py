...
def _scene_momentum_rule() -> Dict[str, Any]:
    return {
        ...
        "do_not_compress": [
            ...
            "уже выбранное POV значимое действие до результата без видимых промежуточных beats",
        ],
        "clarity": (
        ...
        "player_choice": (
            "Если POV уже сделал значимый выбор и действие продолжается, не останавливай сцену для повторного выбора на каждом промежуточном движении. Остановись, когда появляется новый действительно значимый выбор POV."
        ),
        "anti_overstretch": (
        ...
        "valid_endings": [
            ...
            "разумный пропуск времени до следующего содержательного момента, если текущий эпизод действительно исчерпан",
        ],
        "invalid_endings": [
        ...
        "causality": (
            ...
            "Time skip нужен только когда текущий эпизод действительно исчерпан; продолжающаяся важная сцена с меняющимися beats уже является содержательным движением."
        ),
        "instruction": (
            "Рутину сжимай, важное показывай. Эмоциональная, интимная, конфликтная или экшн-сцена может идти несколько ходов, пока каждый ход реально меняет действие, контакт, положение, эмоцию, риск, информацию или цель. "
            "Пиши её ясно и визуально: читатель должен понимать, где люди, что делают и как реагируют. Ощущения не заменяют внешний кадр. "
            "Не своди важный эпизод к итоговому абзацу и не делай time skip только ради темпа. Если значимое действие POV уже выбрано, продолжай его до следующего нового важного выбора. "
            "Когда нового beat больше нет, не растягивай сцену и двигай время дальше."
        ),
    }
