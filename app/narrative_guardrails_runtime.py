...
def _pov_activity_rule() -> Dict[str, Any]:
    return {
        ...
        "instruction": (
            ...
            "В обычном разговоре, если ответ не значимый выбор, отвечай за POV по характеру и поддерживай разговор; юмор/сарказм не default. "
...
def _scene_momentum_rule(context: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "clarity": (
            "Пиши прямо: диалог не стендап, юмор/сарказм не default, голоса не взаимозаменяемы. "
            "В важном телесном/интимном действии неграфично, но ясно показывай последовательность, положение тел, контакт и реакцию; ощущения не заменяют действие. "
