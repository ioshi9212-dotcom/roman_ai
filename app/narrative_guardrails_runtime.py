...
def _scene_momentum_rule(context: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "instruction": (
            ...
            "Сцена: изменение/сжатие. Быт→отношения; романтика→дистанция; интим→ясно/чувственно; экшн→риск/цена; триллер→улика/угроза; драма→последствие. Нет изменения — не стоп на рутине/проверке."
        ),
    }
