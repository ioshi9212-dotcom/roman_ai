...
def _pov_activity_rule() -> Dict[str, Any]:
    return {
        ...
        "reserved_for_player": (
            ...
            "выбор стороны, сексуальное согласие и новое ветвящееся/необратимое решение с заметными последствиями."
        ),
        "rule": (
...
def _scene_momentum_rule(context: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "rule": (
            "Рутину веди до конца, вмешательства или действительно нового ветвящегося решения. "
            "Не останавливайся на микротактике внутри уже выбранного боя, работы, разговора или другой текущей цели: POV сам делает компетентные мелкие шаги. "
            "Короткое действие доводи до результата и реакции, но не начинай за POV новый самостоятельный этап."
        ),
    }
