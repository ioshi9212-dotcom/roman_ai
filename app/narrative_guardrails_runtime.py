...
def _pov_activity_rule() -> Dict[str, Any]:
    return {
        ...
        "automatic_without_player_input": [
            ...
            "естественная непосредственная физическая/эмоциональная реакция, не являющаяся решением, и очевидное продолжение начатого действия",
        ],
        "do_not_silence_pov": [
        ...
        "pre_commit_check": [
            ...
            "до границы значимого выбора POV остаётся видимым участником: говорит, думает, двигается или непосредственно реагирует",
        ...
        "instruction": (
            ...
            "Не спрашивай игрока о мелких действиях и обычных репликах. Даже перед значимым выбором не убирай POV из сцены: показывай его обычную речь, мысли, положение и непосредственные не-решающие реакции до самой границы выбора. Остановись только перед репликой/решением, которое реально определяет позицию POV или заметно меняет отношения, конфликт, сюжет, риск, обязательства или раскрытие информации."
        ),
    }
...
def _character_driven_behavior_rule() -> Dict[str, Any]:
    return {
        ...
        "player_boundary": (
            ...
            "Не выбирай за POV значимое решение, согласие/отказ или реакцию, которая сама определяет его позицию. Но непосредственная физическая/эмоциональная реакция без выбора, обычная реплика, мысль и присутствие POV продолжаются автоматически."
        ),
        "instruction": (
            ...
            "Если конкретный NPC по своим причинам хочет подойти, коснуться, схватить, вмешаться, надавить, решить за POV или поцеловать без предварительного вопроса, это допустимое действие персонажа; игроку остаётся только значимая реакция-решение POV, а его непосредственная реакция и присутствие в кадре не исчезают. "
