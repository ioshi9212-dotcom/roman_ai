...
def _dialogue_naturalism_rule() -> Dict[str, Any]:
    return {
        ...
        "ordinary_reply_modes": [
            "буквально/просто", "спокойно/тепло", "сухо/раздражённо", "неловко/молчанием",
        ],
        "avoid": [
            "цепочка punchline→контрпанч→punchline как обычный ритм",
            "одинаковый сарказм и псевдоофициальные остроты у разных персонажей",
            "автоматическая ответная шутка",
            "стендап до появления серьёзной темы",
        ],
        "voice_check": "Убери имена: если говорящие взаимозаменяемы по сарказму/ритму шуток, верни каждому его собственный голос.",
        "humor_budget_semantics": "Процент сарказма из scene_builder относится ко всей сцене, не к каждой реплике/персонажу.",
        "instruction": (
            "Диалог — разговор разных людей, не общий стендап. Юмор/сарказм не default. "
            "Одна шутка не требует ответной: возможны буквальный ответ, усмешка, игнор, смена темы, молчание. "
            "Обычная бытовая реплика может быть просто обычной."
        ),
    }
...
def _physical_clarity_rule() -> Dict[str, Any]:
    return {
        ...
        "selective": True,
        "applies_when": [
            "романтическое/чувственное/интимное сближение",
            "прикосновения, поцелуи, раздевание, изменение положения тел",
            "лечение, танец, тренировка, драка и иное position-sensitive действие",
        ],
        "concrete_action_sequence_required": True,
        "sensations_supplement_action_not_replace_it": True,
        "non_graphic_is_enough": True,
        "clarity_fields": [
            "кто что сделал и где находится относительно другого",
            "как изменились контакт/поза/одежда, если это важно",
            "какое действие вызвало следующую реакцию",
            "ощущения, дыхание, голос, звуки, паузы и темп как дополнение",
        ],
        "avoid": [
            "эвфемизм вместо действия, если непонятно, что произошло",
            "«убрал последнюю дистанцию»/«ответила движением» как единственное описание перехода",
            "ощущения и эмоции вместо физического действия",
            "монтажный скачок между положениями тел",
            "ненужная графическая анатомическая детализация",
        ],
        "pre_commit_check": "Без перечитывания и догадки понятны последовательность действий и положение участников? Если нет, уточни только недостающий переход.",
        "instruction": (
            "Важная физическая сцена может быть неграфичной, но не туманной: прямо покажи действие, положение/контакт и непосредственную реакцию. "
            "Ощущения, звуки и дыхание усиливают действие, а не заменяют его."
        ),
    }
