...
def _scene_quality_rule() -> Dict[str, Any]:
    return {
        "mandatory": True,
        "core": "Сцена существует не ради процесса, а ради изменения. Тихая сцена допустима; пустая нет.",
        "choice_gate": (
            "Перед возвратом управления спроси: если POV выберет любой разумный вариант следующего действия, "
            "изменится ли что-нибудь существенное? Если нет, это не выбор: продолжай сцену сам."
        ),
        "not_enough_alone": [
            "простое перемещение/смена позиции",
            "ожидание или повторное наблюдение без новой информации",
            "техническое действие или выполнение уже понятного приказа без нового риска/последствия",
            "еда, курение, душ, дорога или обычная работа без изменения отношений, информации, конфликта или цели",
        ],
        "scene_types": {
            "domestic": "Быт раскрывает характер/отношения/юмор/неловкость/социальную динамику или новую мелкую информацию; иначе сожми.",
            "romance": "Меняй эмоциональную дистанцию, желание, доверие, ревность, уязвимость или понимание; показывай конкретно и кинематографично.",
            "intimacy": "Если сцена не пропущена, веди непрерывно, чувственно и ясно; не перескакивай важную часть и не прячь действие в туман.",
            "action_war": "Каждый beat меняет угрозу, тактику, возможность, цель, ресурс, информацию или цену решения; наблюдение/перемещение без этого сжимай.",
            "thriller_supernatural": "Двигай неопределённость новым свидетельством, противоречием, угрозой или нарушением правила; повтор сигнала без новой информации сжимай.",
            "drama_conflict": "Beat меняет позицию, отношение, убеждение, цену решения, расклад между людьми или последствия сказанного/сделанного.",
        },
        "ending_pull": (
            "Конец хода даёт естественную тягу вперёд: значимый выбор, вопрос, напряжение, желание, угрозу, последствие "
            "или эмоциональную незавершённость; не создавай случайный клиффхэнгер."
        ),
        "scene_progressed_semantics": (
            ...
            "физическое движение считается прогрессом только когда меняет риск, возможность, отношения, информацию, цель или последствия."
        ),
        "instruction": (
            "Не превращай интерактивность в меню микродействий. Если варианты отличаются только тем, куда посмотреть, сколько ждать, "
            "идти ли по уже заданному маршруту или сделать очевидный следующий шаг, управление игроку не возвращай."
        ),
    }
