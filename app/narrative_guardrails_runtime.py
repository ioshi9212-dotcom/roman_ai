...
def _scene_quality_rule() -> Dict[str, Any]:
    return {
        "mandatory": True,
        "instruction": (
            "Сцена либо даёт изменение, либо сжимается. Быт: характер/отношения/новая мелкая информация; романтика: эмоциональная дистанция/желание/доверие; "
            "интим: непрерывно, чувственно и ясно; экшн/война: риск/тактика/цена/последствие; триллер/сверхъестественное: новая улика/угроза/нарушение правила; "
            "драма/конфликт: позиция/отношение/последствия. Перед концом: если любой разумный следующий вариант POV ничего существенно не меняет, это не выбор. "
            "Не останавливайся на перемещении, ожидании, повторном наблюдении, выполнении очевидного приказа или техническом шаге. Конец должен естественно тянуть дальше, без случайного клиффхэнгера."
        ),
    }
