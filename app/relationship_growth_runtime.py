...
def _prepare_extracted_for_commit(
    ...
    *,
    ...
    # The visible footer is display-only. Canonical relationship changes must arrive explicitly
    # through causal relationship_updates validated by relationship_policy_runtime.
